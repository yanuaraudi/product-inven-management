    ...
    try {
        ...
        if (image.value) {
            ...
            if (!imageResponse.ok) {
                ...
                error.value = imageData.message || 'Product created, but image upload failed.'
                return
            }
        }
    ...
    >
        <div class="w-full max-w-lg rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
                <h2 class="text-base font-semibold">Create Product</h2>
            ...
            <!-- Form -->
            <form class="space-y-4 px-6 py-5" @submit.prevent="createProduct">
                <!-- Error -->
                <div
                    v-if="error"
